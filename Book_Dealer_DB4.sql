...
insert into AUTHOR values(115,'Salma','Dhaka','Bangladesh')
...
select count(ordno) as NO_OF_ORDER,bookid
from ORDER_DET
...
select count(o.ordno),c.title,c.bookid
from ORDER_DET o,CATALOGUE c
